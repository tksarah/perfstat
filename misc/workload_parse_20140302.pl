...
# [USAGE]
#  ----------------------
#  # ./workload.pl <perfstat.log> <type> <iter_from>-<itre_to>
#  ex) ./workload.pl hoge.log nfsv4 1-10
#
#  Type is nfsv3|nfsv4|cifs|fcp|iscsi
#  ----------------------
### 
# 2014/02/03 v1.0  tk Initial Release
# 2014/02/12 v1.1  tk Include 16k--32767 in Sequential workload
# 2014/03/02 v1.2  tk Multihost support
# 
...
$total = $rtotal + $wtotal;
if ($total == 0){print "$type : Workload is nothing. \n"; exit 0;};
...
print "\n";
print " < $h >\n";
printf (" %-31s\t%5s\t%5s\t%5s\t%5s\n","FileName","RndR%","RndW%","SeqR%","SeqW%");
printf (" %-31s\t%5d\t%5d\t%5d\t%5d\n",$basename,$rnd_r,$rnd_w,$seq_r,$seq_w);
print "\n";
